...
**Edge-Rich Images (Face, Airplane):**

![Face Comparison](results/qualitative/face_x2_comparison.png)
*Left: Original HR | Middle: Bicubic | Right: OLA e-spline*

**Observation:** OLA visibly sharpens:
- Hair strands
- Facial features (eyes, lips)
- Text on aircraft fuselage

The **edge-expansion stage** is responsible - averaging detected edge pixels with second-order neighbors reinforces contrast across boundaries.

**Smooth Images (Baby):**

![Baby Comparison](results/qualitative/baby_x2_comparison.png)

**Observation:** In low-frequency regions, OLA preserves homogeneous areas because:
- High-variance pixels (edges) are absent
- HPF term k × H ≈ 0
- B-spline output essentially unmodified

**Mixed Content (Peppers, Butterfly):**

![Peppers Detail](results/qualitative/peppers_detail.png)

**Observation:** LA filter correctly identifies:
- Smooth skin → High C_p → Minimal blurring → Preserved
- Sharp edges → Low C_p → More blurring → Better edge extraction

**Zoomed Edge Comparison:**

| Image | Bilinear | Bicubic | Lanczos | OLA |
|-------|----------|---------|---------|-----|
| ![](results/qualitative/edge_bilinear.png) | ![](results/qualitative/edge_bicubic.png) | ![](results/qualitative/edge_lanczos.png) | ![](results/qualitative/edge_ola.png) |
| Blurry gradient | Smoother but soft | Sharp but ringing | Sharp, no artifacts |

---

### Limitations and Failure Cases

**1. Extreme Textures (Barbara, Checkerboard)**

![Barbara Texture Failure](results/qualitative/barbara_failure.png)

**Problem:** When **every pixel is high-variance** (dense texture):
- LA filter applies maximum sharpening everywhere
- Combined with additive G_e, can **over-sharpen** smooth transitions
- Results in minor ringing

**Evidence:** FSIM on pure-texture images slightly below Lanczos

**Mitigation:** Could add texture detection to disable edge expansion in high-texture regions

**2. Large Image Processing Time**

**Problem:** Edge-expansion loop is Python, doesn't vectorize
- For 2048×2048 upsampled image: **bottleneck**

**Solution:** 
- C/C++ extension would give 10× speedup
- GPU implementation for real-time HD

**3. CS Convergence on Noisy Images**

**Problem:** 10 nests, 20 generations sometimes converge to local optimum
- Over-sharpens noisy regions

**Solution:** 
- Increase to 25 nests, 50 generations (+3× time)
- Or use fixed-k for stability
